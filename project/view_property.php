...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa-solid fa-r"></i><span><?= $fetch_property['price']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span><span class="fa-solid fa-r" style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="mail.php" class="btn" >Email Interest</a>
      </form>
   </div>
   <?php
      }
